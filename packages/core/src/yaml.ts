...
export interface LocateOption {
  ...
  memory?: string; // internal locate memory key, usually auto-generated by agent
  useMemory?: boolean; // whether to read from short-term memory before AI locate. Defaults to false when omitted.
...
export interface MidsceneYamlScriptWebEnv
  extends MidsceneYamlScriptConfig, MidsceneYamlScriptAgentOpt {
  // for web only
  serve?: string;
  url: string;
...
export interface MidsceneYamlScriptAndroidEnv
  extends MidsceneYamlScriptConfig, Omit<AndroidDeviceOpt, 'customActions'> {
